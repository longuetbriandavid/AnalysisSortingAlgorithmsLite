...
class PipeDrawing(ModelListener):
    ...
    """
    def __init__(self, window : Window, algorithme : AbstractListenableModel, mList : MonitoredList, waitingDelay : int, nbWaitingDelay : int = 0, pipeDisplayMode : bool = False):
        ...
        self.__nbWaitingDelay = nbWaitingDelay
    ...
    def __initDrawPipes(self):
        ...
        for intC in self.__mList:
            intC.addListener(self)
    ...
    def getNbWaitingDelay(self):
        return self.__nbWaitingDelay